...
// TODO: complete implementation of open hashmap with keys and values in the same array at some point
@Ignore
public class OpenHashMapV2Test
{
    private final OpenHashMapV2<Integer, String> classToTest = new OpenHashMapV2<>();
    ...
    public void shouldGrowWhenThresholdExceeded()
    {
        ...
        final OpenHashMapV2<Integer, String> map = new OpenHashMapV2<>(32, loadFactor);
        for (int i = 0; i < 16; i++)
        {
    ...
    public void shouldClearCollection()
    {
        ...
        for (int i = 0; i < 15; i++)
        {
            assertThat(classToTest.get(i), is(Integer.toString(i)));
        }
